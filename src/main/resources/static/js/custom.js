...
( function( $ ) {
  ...
  $( document ).ready( function() { 
    ...
    if ( _wizard_02.exists() ) {
      _wizard_02.bootstrapWizard({'nextSelector': '.button-next', 'previousSelector': '.button-previous'});
    }
    var _wizard_03 = $( '#wizard-03' );
    if ( _wizard_03.exists() ) {
      _wizard_03.bootstrapWizard({'nextSelector': '.button-next', 'previousSelector': '.button-previous', 'firstSelector': '.button-first', 'lastSelector': '.button-last'});
    }

    var _wizard_04 = $( '#wizard-04' );
    if ( _wizard_04.exists() ) {
      _wizard_04.bootstrapWizard({onTabShow: function(tab, navigation, index) {
